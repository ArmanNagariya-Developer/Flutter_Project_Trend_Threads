              ...
              children: [
                ...
                Align(
                  alignment: Alignment.centerRight,
                    ...
                    child: TextButton(onPressed: (){}, child: forgetpassword.text.color(bgColor).make()),
                ),
                //editbutton()
                  editbutton(onPress:(){
                    Get.to(()=>const HomeScreen());
                  },color:bgColor, textColor:whiteColor, title:login).box.width(120).make(),
                 5.heightBox,
                createnewAccount.text.color(Colors.brown).make(),
                5.heightBox,
                editbutton(onPress:(){
                  Get.to(()=>SignupScreen());
                },color:lightgrown, textColor:bgColor, title:signup).box.width(120).make(), //sign up button
                15.heightBox,
